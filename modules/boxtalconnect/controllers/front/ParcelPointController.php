...
class ParcelPointController
{
    ...
    public static function addScripts()
    {
        ...
        $translation = array(
            ...
            'distance' => $boxtalConnect->l('%s km away')
        );
        ...
        $boxtalConnect->addJs('bx-promise-polyfill', '/views/js/promise-polyfill.min.js', 98);
        $boxtalConnect->addJs('bx-mapbox-gl', '/views/js/mapbox-gl.min.js', 99);
        $boxtalConnect->addJs('bx-parcel-point', '/views/js/parcel-point.min.js', 100);

        $boxtalConnect->addCss('bx-mapbox-gl', '/views/css/mapbox-gl.css', 100);
        $boxtalConnect->addCss('bx-parcel-point', '/views/css/parcel-point.css', 100);
