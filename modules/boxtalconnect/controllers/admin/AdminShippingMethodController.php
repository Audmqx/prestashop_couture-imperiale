...
class AdminShippingMethodController extends \ModuleAdminController
{
    ...
    public function init()
    {
        ...
        $tutoUrl = ConfigurationUtil::getTutoUrl();
        ...
        $smarty->assign('tutoUrl', $tutoUrl);
        $smarty->assign('carriersUrl', $boxtalConnect->getContext()->link->getAdminLink('AdminCarriers'));
        $smarty->assign('zonesSettingsUrl', $boxtalConnect->getContext()->link->getAdminLink('AdminZones'));
